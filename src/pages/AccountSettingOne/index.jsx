...
const AccountSettingOnePage = () => {
  const navigate = useNavigate();

  return (
    <>
      <div className="bg-white-A700 flex flex-col font-poppins mx-auto pb-[122px] relative w-full">
        <div className="bg-lime-900 h-[328px] mx-auto w-full"></div>
        <div className="bg-white-A700 flex flex-col items-center justify-start max-w-[1331px] mb-auto mt-[-206px] mx-auto p-[49px] md:px-5 rounded-[20px] shadow-bs w-full z-[1]">
          <div className="flex flex-col items-start justify-start mb-[19px] w-[86%] md:w-full">
            <div className="flex md:flex-col flex-row md:gap-10 items-center justify-between w-[98%] md:w-full">
              ...
              <div className="font-anton md:h-[121px] h-[125px] relative w-[19%] md:w-full">
                <div className="absolute h-[111px] left-[0] top-[0] w-[87%]">
                ...
                <div className="absolute bg-blue_gray-100 flex flex-col h-max inset-[0] items-center justify-center m-auto p-[30px] sm:px-5 rounded-[30px] w-full">
                  <Text
                    className="sm:text-4xl md:text-[38px] text-[40px] text-black-900"
                    size="txtAntonRegular40"
                  >
                    LOGO
                  </Text>
                </div>
...
export default AccountSettingOnePage;
