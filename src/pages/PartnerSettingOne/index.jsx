...
const PartnerSettingOnePage = () => {
  const navigate = useNavigate();

  return (
    <>
      <div className="bg-blue_gray-700 flex font-poppins h-[1117px] justify-end mx-auto relative w-full">
        <div className="flex flex-col h-full items-center justify-end mt-auto mx-auto w-full">
          <div className="flex flex-col md:gap-10 gap-[410px] items-center justify-start w-full">
            <div className="bg-blue_gray-700 h-[328px] w-full"></div>
        ...
        <div className="absolute bg-white-A700 flex flex-col h-max inset-[0] items-center justify-center m-auto max-w-[1331px] p-[49px] md:px-5 rounded-[20px] shadow-bs w-full">
          <div className="flex flex-col items-start justify-start mb-[19px] w-[86%] md:w-full">
            <div className="flex md:flex-col flex-row md:gap-10 items-center justify-between w-[96%] md:w-full">
              <Text
                className="text-5xl sm:text-[38px] md:text-[44px] text-blue_gray-700"
                size="txtPoppinsBold48Bluegray700"
              >
                Partner Information Setting
              </Text>
              <div className="font-anton h-[111px] relative w-[17%] md:w-full">
                <div className="flex m-auto w-full">
                  ...
                  />
                  <Text
                    className="ml-[-13px] mt-2.5 sm:text-[33px] md:text-[35px] text-[37px] text-blue_gray-700 z-[1]"
                    size="txtAntonRegular37Bluegray700"
                  >
                    ZONA
                  </Text>
                </div>
...
export default PartnerSettingOnePage;
